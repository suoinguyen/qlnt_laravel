                        ...
                        <div class="card-body">
                            <div class="form-group">
                                @php
                                    ...
                                    $room_price = strlen(Helpers::getSetting($room_floor_field))>0?Helpers::getSetting($room_floor_field):0;
                                @endphp
                                <label for="bill_room_price">Giá thuê phòng<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control"
                                       id="bill_room_price" name="bill_room_price"
                                       value="{{old('bill_room_price')?:$room_price}}">
                                <small class="form-text text-muted">*Đơn vị giá "nghìn đồng".</small>
                            </div>
                            <div class="form-group">
                                <label for="bill_date_calc_last">Ngày thanh toán kì trước<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control datepicker"
                                       id="bill_date_calc_last" name="bill_date_calc_last"
                                       value="{{old('bill_date_calc_last')}}">
                            </div>
                            <div class="form-group">
                                <label for="bill_date_calc_new">Ngày thanh toán mới<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control datepicker"
                                       id="bill_date_calc_new" name="bill_date_calc_new"
                                       value="{{old('bill_date_calc_new')}}">
                            </div>
                            <div class="form-group">
                                <label for="bill_electric_number_last">Số điện kì trước<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control"
                                       id="bill_electric_number_last" name="bill_electric_number_last"
                                       value="{{old('bill_electric_number_last')}}">
                            </div>
                            <div class="form-group">
                                <label for="bill_electric_number_new">Số điện mới<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control"
                            ...
                            <div class="form-group">
                                <label for="bill_water_number_new">Số nước mới<span class="text-danger">*</span>:</label>
                                <input type="text" class="form-control"
